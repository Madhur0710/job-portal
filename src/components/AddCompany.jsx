...
const schema = z.object({
    name: z.string().min(1,{message: "Comapany name is Required"}),
    logo: z
    .any()
    .refine(
      (file) =>
  ...
  const AddCompany = ({fetchCompanies}) => {
    ...
    const {register,handleSubmit,control,formState: {errors}} =  useForm({
      ...
      const { fn: fnAddCompany, data: dataAddCompany, loading:loadingAddCompany, error: errorAddCompany,} = useFetch(addNewCompany);
