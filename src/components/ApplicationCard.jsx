...
const ApplicationCard = ({application, isCandidate = false}) => {
   ...
   const { fn: fnHiringStatus, loading: loadingHiringStatus } = useFetch(updateApplicationStatus, {
         ...
         <Card>
          ...
          <CardContent className="flex flex-col gap-4 flex-1">
            <div className="flex flex-col md:flex-row justify-between">
                ...
                <div className="flex gap-2 items-center"><Boxes size={15} />{application?.skills}</div>
            </div>
            <hr />
          </CardContent>
